...
#features = ['postcode','number_bedrooms','building']
...
print(R_sq) ##THIS PRINTS R^2 SQUARE

no_bedrooms = input("Number of bedrooms")
postcode = input("Postcode")
linear_pred = linear_model.predict([[no_bedrooms,postcode]])
